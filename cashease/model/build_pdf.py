...
<section class="cover">
  ...
  <div class="rule"></div>
  <p class="lede">Independent multi-service cash kiosks — note-breaking, POS cash-out, airtime and bills. Own the machines. Partner with banks only for cash and settlement. One machine per counted pitch. Prove 350, then fund 2,000. Treat 20,000 kiosks and ₦90 billion as an earned option, not a Year-1 plan.</p>
  <dl>
    <dt>Prepared</dt><dd>August 2026  ·  v1.1</dd>
    ...
    <dt>Best scale</dt><dd>Hold at 2,000 with an ₦8–12 billion facility (DSCR ~2×)</dd>
