...
<section class="cover">
  ...
  <div class="rule"></div>
  <p class="lede">Owned multi-service cash kiosks on everyday streets — petty traders, mallams, bus waits. Note-breaking, POS cash-out, airtime and bills. Pain follows people; availability is ATM-like. The stall’s later offer is a platform: restock, goods on credit, BNPL. The company owns the machines; a bank supplies small notes and settlement. One machine per counted pitch. Raise ₦1.85 billion for 350 kiosks, then fund 2,000. National hubs follow a dense first belt.</p>
  <dl>
    <dt>Prepared</dt><dd>August 2026  ·  v2.7</dd>
