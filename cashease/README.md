...
Owned multi-service cash kiosks on everyday streets in Nigeria — petty traders, mallams, bus waits: note-breaking, POS cash-out, airtime and bills. Pain follows people; availability is ATM-like. The stall’s offer is an inclusive, holistic trade platform (cash → restock → goods on credit / BNPL) for businesses Omni-class apps skip. The company owns the machines; a bank supplies float. One machine per counted pitch. Opening plan: **350 kiosks, ₦1.85 billion**, then **2,000** with an ₦8–12 billion facility.
